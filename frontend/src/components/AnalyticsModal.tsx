...
export const AnalyticsModal = ({ isOpen, onClose }: Props) => {
  const { data: stats, isLoading } = useQuery({
    ...
    queryFn: async () =>
      (await axios.get('http://localhost:3000/admin/stats')).data,
    enabled: isOpen, // Solo cargar cuando se abre
  });
          ...
          {isLoading ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 30 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20 }}>
                {/* GRÁFICO 1: CARGA DE TRABAJO (BARRAS) */}
...
// Estilos rápidos en línea (puedes moverlos a SASS si prefieres)
